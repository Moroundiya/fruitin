        ...
        <div className="w-full xl:w-5/5 2xl:4/5 mx-auto mt-5 sm:mt-20 md:mt-28 lg:mt-[170px] flex flex-col items-center relative pb-5">
            ...
            <div className="lg:flex justify-center items-center">
                <div className="font-lexend mb-14 mt-[140px] lg:mt-0 relative lg:flex lg:justify-center lg:items-center lg:flex-col lg:w-1/2">
                    ...
                    <p className="text-white flex flex-col items-center text-[2.8rem] text-center px-3 leading-tight sm:px-0 mx-auto font-bold my-6 sm:mx-auto sm:text-6xl sm:leading-[1.1] lg:text-[4.3rem] xl:text-7xl lg:w-full xl:mt-8 xl:mb-14 2xl:mb-10 xl:leading-[1.2] 2xl:leading-[1.1] 2xl:text-[5.4rem]">
                        <span>{title1}</span>
                        <span>{title2}</span>
                    </p>
