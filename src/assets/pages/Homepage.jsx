				...
				<div className="w-full h-full justify-center px-3 items-center lg:px-12 xl:px-0 xl:w-11/12 2xl:w-4/5 lg:mx-auto">
					<div className="w-full flex justify-between items-center">
						...
						<form className="w-1/2 flex justify-end">
							...
							<button
								type="submit"
								className='bg-[#017D03] text-white rounded-lg ms-2 text-sm px-4 z-50 overflow-hidden relative transition-all duration-700 after:transition-all after:duration-700 after:origin-bottom after:content-[""] after:absolute after:top-0 after:left-0 after:-z-10 after:w-full after:h-full after:bg-[#FF9C00] after:scale-y-0 after:hover:scale-y-[1]'>
								Subscribe
							</button>
						</form>
					</div>
					<hr className="h-px my-16 bg-[#017D03] border-0" />
					<div className="flex justify-center">
						<div className="w-1/3">
							<img
								...
								alt=""
							/>
							<p className="text-[#B5B5B5] my-10 leading-[1.5] text-[0.98rem] font-light w-4/5">
						...
						<div className="w-1/4">
							...
							<div>
								<p className="text-[#B5B5B5] text-[0.98rem] font-light flex items-center space-x-1.5 cursor-pointer hover:text-[#FF9C00]">
									<Icon
						...
						<div className="w-1/4">eee p</div>
						<div className="w-1/4">eee</div>
					</div>
				</div>
			</footer>
		</>
