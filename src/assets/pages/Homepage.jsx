    ...
    return (
        <>
            ...
            >
                ...
                <SwiperSlide className='w-full h-full bg-heroBg bg-cover bg-center bg-no-repeat'>Slide 3</SwiperSlide>
                <SwiperSlide className='w-full h-full bg-heroBg bg-cover bg-center bg-no-repeat'>Slide 4</SwiperSlide>
