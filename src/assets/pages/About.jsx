    ...
    return (
        <>
            ...
            <div className='mt-[100px] lg:mt-[170px]'>
                <div className=" w-full min-h-fit flex flex-col font-lexend pt-10 pb-5 bg-no-repeat lg:flex-row lg:px-12 xl:w-4/5 lg:py-14 lg:mx-auto relative">
                    ...
                    <div className="px-3 lg:w-1/2 flex flex-col justify-center">
                        ...
                        <ul className="text-black text-[1.05rem] font-semiold w-fit mt-5 space-y-5 lg:space-y-0 lg:mt-0 lg:space-x-5 lg:flex justify-between items-center">
