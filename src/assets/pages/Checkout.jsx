                    ...
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <div className="mt-10 mb-3 w-full mx-auto lg:mb-8 lg:mt-12">
                            ...
                            <div className="flex flex-col items-center lg:items-start">
                                ...
                                <form
                                    action=""
                                    className="py-10 w-full lg:w-4/6 mx-auto relative z-20">
                                ...
                                <form action='/order' method='' className='mt-8 w-full mb-20'>
                                    ...
                                    <div className="flex mb-2 lg:mb-3 flex-col">
                                        ...
                                        <p className={`ms-7 text-[#a1b1bc] bg-[#ecf0f1]  border-[#d8d8d8] font-light  text-sm lg:w-fit transition-all ease-in-out duration-500 overflow-hidden max-h-0 px-2 ${paymentMethod == 'bank' ? 'max-h-[100px] py-2 border my-2' : ' max-h-0 border-none'}`}>Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order will not be shipped until the funds have cleared in our account.</p>
                                    </div>
                                    <div className="flex mb-2 lg:mb-3 flex-col">
                                        ...
                                        <p className={`ms-7 text-[#a1b1bc] bg-[#ecf0f1] border overflow-hidden max-h-0 border-[#d8d8d8] font-light px-2 text-sm lg:w-fit transition-all ease-in-out duration-500 ${paymentMethod == 'cheque' ? 'max-h-[100px] py-2 border my-2' : ' max-h-0 border-none'}`}>Please send a check to Store Name, Store Street, Store Town, Store State / County, Store Postcode.</p>
                                    ...
                                    <div className="flex mb-2 lg:mb-3 flex-col">
                                        ...
                                        <p className={`ms-7 text-[#a1b1bc] bg-[#ecf0f1] border overflow-hidden max-h-0 border-[#d8d8d8] font-light px-2 text-sm lg:w-fit transition-all ease-in-out duration-500 ${paymentMethod == 'card' ? 'max-h-[100px] py-2 border my-2' : ' max-h-0 border-none'}`}>Pay with cash upon delivery.</p>
                                    ...
                                    <div className="flex mb-2 lg:mb-3 flex-col">
                                        ...
                                        <p className={`${paymentMethod == 'paypal' ? 'max-h-[100px] py-2 border my-2' : ' max-h-0 border-none'} ms-7 text-[#a1b1bc] bg-[#ecf0f1] border overflow-hidden max-h-0 border-[#d8d8d8] font-light px-2 text-sm lg:w-fit transition-all ease-in-out duration-500`}>Pay via PayPal; you can pay with your credit card if you don’t have a PayPal account.</p>
                                    </div>
