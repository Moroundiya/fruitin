...
export const Experience = () => {
	...
	return (
		<div className="mt-[100px] lg:mt-[170px] xl:mt-[120px] mb-10 lg:mb-12">
			<div className=" w-full min-h-fit flex flex-col font-lexend pt-10 bg-no-repeat overflow-x-clip  lg:flex-row lg:px-12 xl:w-4/5 lg:pt-14 lg:mx-auto relative">
				<motion.img
					src={aboutUsBg}
					alt=""
				...
				<div className="px-3 lg:w-1/2 flex flex-col justify-center overflow-x-clip">
					<motion.div
